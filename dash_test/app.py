...
def user_info(json_data, username):
    ...
    mostPopTweetURL = "https://twitter.com/user/status/" + json_data["most_popular_tweet"]
    topTweetStr = '<blockquote class="twitter-tweet"><a href="' + mostPopTweetURL + '"></a></blockquote><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>'
    leastTweetStr = '<blockquote class="twitter-tweet"><a href="' + mostPopTweetURL + '"></a></blockquote><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>'
